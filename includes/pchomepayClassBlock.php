...
class Pchomepay_Gateway_Blocks extends AbstractPaymentMethodType {
    ...
    public function initialize() {
        error_log('pchomepayClassBlock of initialize');
        $this->settings = get_option( 'woocommerce_my_custom_gateway_settings', [] );
        $this->gateway = new WC_Gateway_PChomePay();
    }

    public function is_active() {
        error_log('pchomepayClassBlock of is_active');
        return $this->gateway->is_available();
    }

    public function get_payment_method_script_handles() {
        error_log('pchomepayClassBlock of get_payment_method_script_handles');
    ...
    public function get_payment_method_data() {
        error_log('pchomepayClassBlock of get_payment_method_data');
        return [
